...
Това е модел обединение на моделите за мобилност и за репелент против комари. \\
...
\begin{table}[h]
  ...
  \begin{tabular}{ |c c|c c|  }
    \hline
    Параметър & Описание & М. 1 & М. 2\\
    \hline
    $\beta_{vh}$ & Вероятност на прехвърляне на патогена от комар на човек & \multicolumn{2}{c|}{0.5}\\
    $\beta_{hv}$ & Вероятност на прехвърляне на патогена от човек на комар  & \multicolumn{2}{c|}{0.1}\\
    $a_i$ & Честота на ухапвания [$\text{ден}^{-1}$] & 0.12 & 0.18\\
    $M_i$ & Популация на женски комари  & $6 \times 10^7$ & $1.6 \times 10^8$\\
    $\mu_i$ & Смъртност на комари [$\text{ден}^{-1}$] & $\frac{1}{21}$ & $\frac{1}{15}$\\
