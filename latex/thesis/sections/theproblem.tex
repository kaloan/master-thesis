...
\end{equation}
Тъй като първоначалният брой заразени хора и комари влияят на развитието на системата ще търсим множеството на начални условия, за които всички траектории на \eqref{eq:TheDimensionlessProblem}:
\begin{equation}
