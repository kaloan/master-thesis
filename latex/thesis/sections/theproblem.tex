...
Това е модел обединение на моделите за мобилност \eqref{eq:MigrationProblem} и за репелент против комари \eqref{eq:RepellentProblem} и отново се запазват означенията от дефиниция \ref{def:Parameters}, както на другите въведени в тези модели. Таблична форма на всичките параметри е поставена долу в таблица \ref{tbl:ParameterDefinitions}. \\
Трябва да се отбележи, че в модела \eqref{eq:TheProblem} се допуска, че хората са предпазени от репелента спрямо местообитанието, чиито жители са.
...
\end{equation}
Тоест така се разглежда дяла от жители, които са заразени, вместо техния брой, а за допълнително опростяване на изразите може да бъдат направени следните полагания:
