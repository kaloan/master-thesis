\section{\hspace{1em} Основни свойства на модела}
\begin{lemma}
  \label{lemma:Modulus}
...
Възможно е в двете местообитания да липсва ендемизъм за произволен избор на мобилности.
% Възможно е в едното местообитание да липсва ендемизъм при всевъзможните мобилности, но в другото поне за някои от тях да има.
Често в областта на малки мобилности $p_{11}, p_{22} \approx 1$ има силно изменение в пропорцията заразени в ендемичното състояние.
