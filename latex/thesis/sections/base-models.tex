...
%     % % right
%     % \node (ih1) [hostp, right of=sh1, text width=15mm, xshift=10mm] {infected (X_1)};

%     % \node (iv1) [vectorp, below of=ih1, yshift=-10mm, text width=15mm] {infected (Y_1)};
...
%   \end{tikzpicture}
%   \caption{figure}{Диаграма на модела \eqref{eq:MigrationProblem}}
%   \label{fig:Model}
% \end{figure}
