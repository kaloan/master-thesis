...
\begin{frame}[t]{Свойства на задачата \ref{eq:TheDimensionlessProblem}}
  \begin{proposition}
    За системата \ref{eq:TheDimensionlessProblem} са в сила:
    \begin{enumerate}
...
\begin{frame}[t]{Съществуване на решение на \ref{eq:TheDimensionlessProblem}}
  ...
  \end{multline*}
  Сега може да ползваме лемата \ref{lemma:Modulus} за $f_{x_1}$ с:
  \begin{equation*}
...
\begin{frame}[t]{Кооперативност на \ref{eq:TheDimensionlessProblem}}
  ...
  \begin{frame}[t]{Неразложимост на \ref{eq:TheDimensionlessProblem}}
