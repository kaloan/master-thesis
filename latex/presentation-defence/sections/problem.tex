...
\begin{frame}[t]{Схема на модела}
  \begin{figure}{}
    ...
    \caption{\dashuline{Черна пунктирана линия}: възможен преход на индивид от класа в началото в класа в края.\\
      \underline{Черна непрекъсната линия}: индивид от началото може да зарази индивид от края.\\
    \textcolor{blue}{\dotuline{Синя линия}}: мобилност}
...
\begin{frame}[t]{Уравнения на модела}
  \begin{footnotesize}
    ...
    \end{equation}
  \end{footnotesize}
  Моделът включва мобилност \myfootcite{Bichara2016} с добавена \textcolor{red}{употреба на репелент} \myfootcite{Rashkov2022}.
\end{frame}
