...
constexpr auto Nx1 = 35;
constexpr auto dx1 = Imax1 / (Nx1 - 1);
constexpr auto Nx2 = 35;
...
template <size_t n1, size_t n2, size_t n3, size_t n4>
Array4D<n1, n2, n3, n4>
    __always_inline weightedSum(const unique_ptr<Array4D<n1, n2, n3, n4>> &mat1,
...
template <size_t n1, size_t n2, size_t n3, size_t n4>
__always_inline Array4D<n1, n2, n3, n4>
halfSum(const Array4D<n1, n2, n3, n4> &mat1,
...
template <size_t n1, size_t n2, size_t n3, size_t n4>
__always_inline void
derf(const unique_ptr<Array4D<n1, n2, n3, n4>> &mat) noexcept {
...
int main(int argc, char *argv[]) {
  ...
  while (currentError > errtol) {
    ...
    *wnew0 = weightedSum(w, wnew1, 3. / 4., 1. / 4.);
    performTimeStep(wnew1, wnew0, dt);
    auto wnew = weightedSum(w, wnew1, 1. / 3., 2. / 3.);
