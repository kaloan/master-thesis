      ...
      for (size_t i3 = 0; i3 < y1.size(); ++i3) {
        for (size_t i4 = 0; i4 < y2.size(); ++i4) {
          ...
          hamilt +=
              ...
              abs(hx1a) * ((*Fx1p)[i1][i2][i3][i4] - (*Fx1m)[i1][i2][i3][i4]) /
                  2.;
          hamilt +=
              hx2a * ((*Fx2p)[i1][i2][i3][i4] + (*Fx2m)[i1][i2][i3][i4]) / 2. -
              abs(hx2a) * ((*Fx2p)[i1][i2][i3][i4] - (*Fx2m)[i1][i2][i3][i4]) /
                  2.;
          hamilt +=
              hy1a * ((*Fy1p)[i1][i2][i3][i4] + (*Fy1m)[i1][i2][i3][i4]) / 2. -
              abs(hy1a) * ((*Fy1p)[i1][i2][i3][i4] - (*Fy1m)[i1][i2][i3][i4]) /
                  2.;
          hamilt +=
              hy2a * ((*Fy2p)[i1][i2][i3][i4] + (*Fy2m)[i1][i2][i3][i4]) / 2. -
              abs(hy2a) * ((*Fy2p)[i1][i2][i3][i4] - (*Fy2m)[i1][i2][i3][i4]) /
                  2.;
