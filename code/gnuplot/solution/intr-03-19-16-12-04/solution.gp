...
plot 'patch-dynamics-1-0-1-0.csv' skip 1 using 1:2 w l dt 2 lw 2 lc rgb "red", 'patch-dynamics-0.99-0-0.9-0.csv' skip 1 using 1:2 w l dt 2 lw 2 lc rgb "blue", 'patch-dynamics-1-0.39-1-0.12.csv' skip 1 using 1:2 w l dt 1 lw 2 lc rgb "red", 'patch-dynamics-0.99-0.39-0.9-0.12.csv' skip 1 using 1:2 w l dt 1 lw 2 lc rgb "blue"
#unset label 1
unset arrow 1
...
#no rep, no mob; no rep, mob; rep, no mob; rep, mob
plot 'patch-dynamics-1-0-1-0.csv' skip 1 using 1:3 w l dt 2 lw 2 lc rgb "red", 'patch-dynamics-0.99-0-0.9-0.csv' skip 1 using 1:3 w l dt 2 lw 2 lc rgb "blue", 'patch-dynamics-1-0.39-1-0.12.csv' skip 1 using 1:3 w l dt 1 lw 2 lc rgb "red", 'patch-dynamics-0.99-0.39-0.9-0.12.csv' skip 1 using 1:3 w l dt 1 lw 2 lc rgb "blue"
#unset label 2
unset arrow 2
unset multiplot
